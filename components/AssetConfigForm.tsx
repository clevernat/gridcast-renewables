          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-3 !bg-white !text-black border-2 border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 !bg-white !text-black border-2 border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm"
              style={{ color: "#000000", backgroundColor: "#ffffff" }}
              required
            />
          </div>
        ...
        <div className="space-y-4 p-5 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-xl border-2 border-yellow-200">
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., 7"
              className="w-full px-4 py-3 !bg-white !text-black border-2 border-gray-200 rounded-xl focus:outline-none focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 transition-all text-sm"
              style={{ color: "#000000", backgroundColor: "#ffffff" }}
            />
          ...
          <div className="grid grid-cols-3 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="3"
                className="w-full px-3 py-3 !bg-white !text-black border-2 border-gray-200 rounded-xl focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all text-sm"
                style={{ color: "#000000", backgroundColor: "#ffffff" }}
              />
            </div>
            <div>
